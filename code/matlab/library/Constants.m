...
% Obtained from JPL: https://ssd.jpl.nasa.gov/
...
%% Planet characteristics and orbits
% physical parameters: https://ssd.jpl.nasa.gov/?planet_phys_par
% orbital parameters: https://ssd.jpl.nasa.gov/txt/p_elem_t1.txt
...
%% Satellite characteristics and orbits
% physical parameters:
% orbital parameters: https://ssd.jpl.nasa.gov/?sat_elem
...
% Jupiter
Europa.gravP = 3202.739e9;
Europa.radius = 1565.0e3;   % ref[1]
Europa.j2 = 435.5e-6;       % ref[1]
Europa.a = 671100e3;
Europa.e = 0.0094;

Ganymede.gravP = 9887.834e9;
Ganymede.radius = 2631.2e3; % ref[1]
Ganymede.j2 = 127.53e-6;    % ref[1]
...
%% References
% [1] Schubert 2004 - Interior composition, structure and dynamics of the Galilean satellites